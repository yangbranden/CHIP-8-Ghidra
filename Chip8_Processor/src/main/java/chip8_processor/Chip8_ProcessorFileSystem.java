...
@FileSystemInfo(type = "fstypegoeshere", // ([a-z0-9]+ only)
		description = "File system description goes here", factory = Chip8_ProcessorFileSystem.MyFileSystemFactory.class)
public class Chip8_ProcessorFileSystem implements GFileSystem {
	 ...
	 */
	public Chip8_ProcessorFileSystem(FSRLRoot fsFSRL, ByteProvider provider) {
		this.fsFSRL = fsFSRL;
	...
	public void mount(TaskMonitor monitor) {
		monitor.setMessage("Opening " + Chip8_ProcessorFileSystem.class.getSimpleName() + "...");
	...
	public static class MyFileSystemFactory
			implements GFileSystemFactoryByteProvider<Chip8_ProcessorFileSystem>,
			GFileSystemProbeByteProvider {

		@Override
		public Chip8_ProcessorFileSystem create(FSRLRoot targetFSRL,
				ByteProvider byteProvider, FileSystemService fsService, TaskMonitor monitor)
				throws IOException, CancelledException {

			Chip8_ProcessorFileSystem fs = new Chip8_ProcessorFileSystem(targetFSRL, byteProvider);
			fs.mount(monitor);
			return fs;
		}
